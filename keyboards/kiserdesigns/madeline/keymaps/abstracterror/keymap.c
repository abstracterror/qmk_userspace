...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        MT_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, KC_N,    KC_M,    KC_COMM, KC_DOT,
        XXXXXXX,          AE_MEH,     MT_TAB,           LT_SPC,        XXXXXXX,          KC_SLSH
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, KC_7,    KC_8,    KC_9,
        XXXXXXX,          XXXXXXX,    _______,          LT_0,          XXXXXXX,          KC_PIPE
    ),
    ...
    [_NAV] = LAYOUT(
        ...
        XXXXXXX,          XXXXXXX,    MT_CWT,           _______,       XXXXXXX,          KC_INS
    ),
};
    ...
    const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
        ...
        [_FUN] =  { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN) },
