...
const char PROGMEM chordal_hold_layout[MATRIX_ROWS][MATRIX_COLS] = LAYOUT_row_3u_bars(
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUN] = LAYOUT_row_3u_bars(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   XXXXXXX,
                          _______,          KC_LSFT, LT_F10,           _______
    ),

    [_NUM] = LAYOUT_row_3u_bars(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, UM_EURO, KC_7,    KC_8,    KC_9,    KC_PIPE,
                          _______,          KC_LSFT, LT_0,             _______
    ),

    [_LSYM] = LAYOUT_row_3u_bars(
