...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        MT_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_RSFT,
                 XXXXXXX,          AE_MEH,  MT_TAB,  LT_SPC,  QK_REP,           XXXXXXX
    ),
    ...
    [_FUN] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   XXXXXXX,
                 XXXXXXX,          XXXXXXX, KC_LSFT, LT_F10,  KC_F11,           XXXXXXX
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, UM_EURO, KC_7,    KC_8,    KC_9,    KC_PIPE,
                 XXXXXXX,          XXXXXXX, KC_LSFT, LT_0,    _______,          XXXXXXX
    ),
    ...
    [_LSYM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                 XXXXXXX,          _______, KC_LSFT, _______, XXXXXXX,          XXXXXXX
    ),
