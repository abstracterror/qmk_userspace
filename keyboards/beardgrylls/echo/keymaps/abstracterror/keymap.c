...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
        ...
        _______, _______, _______,          _______, KC_LSFT,    LT_0,    _______,          _______, _______, _______
    ),
    ...
    [_FUN] = LAYOUT(
        ...
        _______, _______, _______,          _______, KC_LSFT,    LT_F10,  _______,          _______, _______, _______
    ),
