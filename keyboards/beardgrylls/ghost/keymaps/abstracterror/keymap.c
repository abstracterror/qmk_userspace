...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUN] = LAYOUT(
        ...
        XXXXXXX,                   XXXXXXX, KC_LSFT, LT_F10,  XXXXXXX,                   RM_TOGG
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        XXXXXXX,                   XXXXXXX, KC_LSFT, LT_0,    XXXXXXX,                   XXXXXXX
    ),
    ...
    [_LSYM] = LAYOUT(
        ...
        TG_TSYM,                   XXXXXXX, KC_LSFT, _______, XXXXXXX,                   XXXXXXX
    ),

    [_TSYM] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RM_SPDU,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RM_NEXT, RM_HUEU, RM_SATU, RM_VALU, RM_SPDD,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RM_PREV, RM_HUED, RM_SATD, RM_VALD,
        TG_TSYM,                   XXXXXXX, KC_LSFT, _______, XXXXXXX,                   XXXXXXX
    ),
