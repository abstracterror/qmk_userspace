...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RM_HUED, XXXXXXX, KC_4,    KC_5,    KC_6,    _______,
    ...
    [_FUN] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, UK_TOGG, QK_BOOT, RM_PREV, RM_SPDU, KC_F4,   KC_F5,   KC_F6,   XXXXXXX,
    ...
    [_LSYM] = LAYOUT(
        XXXXXXX, KC_PLUS, KC_UNDS, KC_DQUO, XXXXXXX, RM_SATD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    [_NAV] = LAYOUT(
        ...
        UNDO,    CUT,     COPY,    PASTE,   XXXXXXX,          KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_INS,
                          _______, MT_CWT,  _______, RM_VALU, _______, _______, _______
    ),
