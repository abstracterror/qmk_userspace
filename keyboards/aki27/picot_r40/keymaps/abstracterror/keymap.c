...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUN] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, _______, _______, LT_F10,  XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, _______, _______, LT_0,    XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_LSYM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX
    ),
