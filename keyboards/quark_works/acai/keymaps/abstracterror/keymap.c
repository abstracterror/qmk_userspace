...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUN] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, XXXXXXX, XXXXXXX, LT_F10,  XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LSFT, XXXXXXX, XXXXXXX, LT_0,    XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_TSYM] = LAYOUT(
        ...
        _______, KC_LSFT, XXXXXXX, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
