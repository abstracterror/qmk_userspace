...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, AE_MEH,           MT_TAB,  LT_SPC,           XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_FUN] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX,          _______, LT_F10,           XXXXXXX, XXXXXXX, XXXXXXX
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX,          _______, LT_0,             XXXXXXX, XXXXXXX, XXXXXXX
    ),
