...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        KC_F1,   KC_F5,   KC_F8,   KC_F10,  KC_F11,
    ...
    [_FUN] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F7,   KC_F8,   KC_F9,   XXXXXXX,
                 _______, _______, _______, KC_LSFT, LT_F10,  _______, _______, _______
    ),
    ...
    [_NUM] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, UM_EURO, KC_7,    KC_8,    KC_9,    KC_PIPE,
                 _______, _______, _______, KC_LSFT, LT_0,    _______, _______, _______
    ),
