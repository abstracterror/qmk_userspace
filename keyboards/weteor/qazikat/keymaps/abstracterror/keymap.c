...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUN] = LAYOUT_split_4space(
        ...
        _______, _______, _______, KC_LSFT,          LT_F10,           _______, _______, _______, _______
    ),

    [_NUM] = LAYOUT_split_4space(
        XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, KC_4,    KC_5,    KC_6,    _______, _______,
        ...
        _______, _______, _______, KC_LSFT,          LT_0,             _______, _______, _______, _______
    ),

    [_LSYM] = LAYOUT_split_4space(
        XXXXXXX, KC_PLUS, KC_UNDS, KC_DQUO, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    ...
    [_NAV] = LAYOUT_split_4space(
        ...
        KC_CAPS, _______, _______, KC_LSFT,          _______,          _______, _______, _______, _______
    ),
};
